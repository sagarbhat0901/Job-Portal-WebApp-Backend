...
//This is the rest controller class for BookmarkedJob module.
@RestController
...
public class BookmarkedJobController {
	...
	//This method request for the data, checks validation of the data and creates bookmark for job.
	@PostMapping("/add")
	...
	//delete a job by id and returns the status.
