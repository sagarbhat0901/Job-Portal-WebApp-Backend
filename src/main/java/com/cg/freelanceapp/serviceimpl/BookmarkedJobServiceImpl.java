...
//This is the Service Implementation for BookmarkedJob module.
@Service
public class BookmarkedJobServiceImpl implements IBookmarkedJobService {
	...
	//The method saves a new bookmarkedjob object.
	@Transactional
	...
	//The method finds BookmarkedJob by Skill name, and returns a list.
	@Override
	@Transactional
	...
	//The method finds BookmarkedJob by their Id, and returns a list.
	@Transactional
	@Override
	...
	//The method finds BookmarkedJob by their Id, and remove it from the list.
	@Transactional
	...
	//The method finds all BookmarkedJob objects
	@Override
